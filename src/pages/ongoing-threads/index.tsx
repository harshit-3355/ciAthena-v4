...
import { muiStyles, styles } from '#/pages/ongoing-threads/style';
...
const OngoingThreadsPage = () => {
  ...
  const renderIntroSection = () => (
    <>
      <Typography variant='h4' sx={introTitle} display='flex' justifyContent='center'>
        Let’s embark on a journey of
        <div style={styles.slideUpContainer}>
          <p style={styles.slideUpItems}>knowledge</p>
          <p style={styles.slideUpItems}>exploration</p>
          <p style={styles.slideUpItems}>discovery</p>
          <p style={styles.slideUpItems}>insights</p>
        </div>
      </Typography>
      <NewQuerySection
